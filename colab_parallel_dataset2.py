#!/usr/bin/env python3
"""
Colab并行执行 - 数据集组2：SVOX (sun + night)
适合在Notebook 2中运行
"""
...
experiments = [
    ...
    # CosPlace - SVOX Night - Dot Product
    ["python", "VPR-methods-evaluation/main.py",
     "--method", "cosplace", "--backbone", "ResNet18",
     "--descriptors_dimension", "512", "--image_size", "512", "512",
     "--database_folder", "data/svox/images/test/gallery",
...
def main():
    print("="*70)
    print("  🚀 并行执行组2：SVOX Sun + Night (CosPlace)")
    print("  实验数量: 4")
    print("  预计时间: 1.5-2小时")
    print("="*70)
